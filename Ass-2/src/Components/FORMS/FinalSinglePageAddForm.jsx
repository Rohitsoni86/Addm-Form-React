...
export default function FinalSinglePageAddForm() {
  ...
  return (
    <>
      ...
      <TableData stuData={studentdata} fatherData={fatherdetails} motherData={motherdetails} EmgContData={emergDetails} />
